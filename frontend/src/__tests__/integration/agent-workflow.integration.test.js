/**
 * agent-workflow.integration.test.js - Agent Management Workflow Integration Tests
 *
...
describe('Agent Workflow Integration Tests', () => {
  ...
  describe('Agent Creation Workflow', () => {
    ...
    test('should create nested team agent successfully', async () => {
      ...
      // Add sub-agents
      const subAgentInput = screen.getByLabelText(/sub agents/i);
  ...
  describe('Agent Edit Workflow', () => {
    ...
    test('should update agent successfully', async () => {
      server.use(
        ...
        rest.put(`${API_URL}/api/agents/:agentName`, async (req, res, ctx) => {
          const body = await req.json();
    ...
    test('should handle edit errors', async () => {
      server.use(
        ...
        rest.put(`${API_URL}/api/agents/:agentName`, (req, res, ctx) => {
          return res(
            ctx.status(400),
  ...
  describe('Agent Run Workflow', () => {
    ...
    test('should start agent execution', async () => {
      const mockWS = global.createMockWebSocketServer(

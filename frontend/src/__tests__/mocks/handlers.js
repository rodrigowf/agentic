/**
 * handlers.js - Mock Service Worker (MSW) Request Handlers
 *
...
export const agentHandlers = [
  ...
  rest.get(`${API_URL}/api/agents/:agentName`, (req, res, ctx) => {
    ...
    return res(
      ctx.status(200),
      ctx.json(mockAgentConfig)
    );
  }),

  // Create/Update agent
  rest.post(`${API_URL}/api/agents`, async (req, res, ctx) => {
...
export const toolHandlers = [
  ...
  // Upload tool
  rest.post(`${API_URL}/api/tools`, async (req, res, ctx) => {
    return res(
      ctx.status(200),
...
export const voiceHandlers = [
  ...
  // Get conversation
  rest.get(`${API_URL}/api/voice-conversations/:conversationId`, (req, res, ctx) => {
  ...
  // Create conversation
  rest.post(`${API_URL}/api/voice-conversations`, async (req, res, ctx) => {
    const body = await req.json();
  ...
  // Delete conversation
  rest.delete(`${API_URL}/api/voice-conversations/:conversationId`, (req, res, ctx) => {
    return res(
      ctx.status(200),
...
export const errorHandlers = [
  ...
  rest.get(`${API_URL}/api/error/network`, (req, res, ctx) => {

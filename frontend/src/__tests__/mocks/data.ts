...
export const mockConversations: VoiceConversation[] = [
  {
    id: 'conv-123',
...
export const mockVoiceMessages: BaseMessage[] = [
  {
    id: 1,
...
export const mockClaudeCodeMessages: BaseMessage[] = [
  {
    id: 1,
...
export const mockNestedAgentMessages: BaseMessage[] = [
  {
    id: 1,
...
export const mockModelsByProvider: Record<string, string[]> = {
  openai: [

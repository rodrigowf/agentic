...
def _refresh_agent_system_message():
    """
    Refreshes the agent's system message with current short-term memory content.
    This injects the short-term memory into the {{SHORT_TERM_MEMORY}} placeholder.
    """
    try:
        ...
        if agent._system_messages:
            ...
            logger.info("Agent system message refreshed with current short-term memory")
        else:
